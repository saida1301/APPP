...
useEffect(() => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      if (!title || !about || !selectedOption || (selectedOption === '1' && !price) || !deadline) {
        showAlert(t('all')); 
        return;
      }
  ...
  placeholderStyle={[styles.placeholderStyle,  { color: isDarkMode ? 'black' : 'black' }]}
  ...
  placeholderTextStyle={isDarkMode ? 'red' : 'red'} // Set the placeholder text color based on the isDarkMode flag
/>
          ...
          >
            <Picker.Item label="Odenissiz" value="0" color={ isDarkMode ? 'black' : 'black' } />
            <Picker.Item label="Odenisli" value="1" />
          </Picker>
          {selectedOption === '1' && (
            <TextInput
              placeholder="Price"
        ...
        <View>
          ...
          <Pressable onPress={handleImagePicker} style={[styles.container5,  {backgroundColor: isDarkMode ? "#1B1523" : 'white'},]}>
