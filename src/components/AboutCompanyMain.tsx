...
>
              ...
              <>
                ...
                <View>
                  <View
                    ...
                    {salamm.slice(0, numToShow).map((item: any) => (
                     <Pressable key={item.id} onPress={() => handlePresss(item.id)} style={{marginBottom:10}}>
                     <View
                       style={[
                         styles.card,
                         {
  ...
  {likedVacanciesData?.some(v => v.id === item.id) ? (
                         ...
                         <View>
                           <Text style={[styles.title, { color: isDarkMode ? '#FDFDFD' : '#020202' }]}>{item.position}</Text>
     
                           <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                             <View style={{ flexDirection: 'row' }}>
                               <Image source={require('AwesomeProject/src/assets/images/buildingnew.png')} style={{ width: 15, height: 15 }} />
                               <Text style={[styles.company, { color: isDarkMode ? '#FDFDFD' : '#C7C7C7', marginLeft: 4 }]}>
