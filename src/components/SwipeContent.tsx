  ...
  {decodeHTMLEntities(getCompanyName(vacancies[currentIndex]?.company_id))}
      ...
      >
        <View style={styles.buttonsContainer}>
          <Pressable style={[styles.button2, styles.dislikeButton,{backgroundColor : isDarkMode ? "black" : "white" } ]} onPress={handleDislikeVacancy}>
            <Image source={require('AwesomeProject/src/assets/images/close.webp')} style={styles.buttonImage} />
          </Pressable>
          <Pressable style={[styles.button2, styles.likeButton, {backgroundColor : isDarkMode ? "black" : "white" } ]} onPress={handleLikeVacancy}>
            <Image source={require('AwesomeProject/src/assets/images/like.webp')} style={styles.buttonImage} />
          </Pressable>
        </View>
      </PanGestureHandler>
    </View>
